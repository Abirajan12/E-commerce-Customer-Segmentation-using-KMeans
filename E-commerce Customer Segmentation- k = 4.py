...
cluster_4 = final_cluster_data[final_cluster_data['Cluster labels'] == 3]


# In[54]:


cluster_4_df = cluster_4.iloc[:,3:-1].sum().sort_values(ascending = False).reset_index()
cluster_4_df.columns = ['Brand', 'count']
cluster_4_df
...
top_10_cluster_4 = cluster_4_df.head(10)
...
plt.figure(figsize=(10, 6))
plt.bar(top_10_cluster_4['Brand'], top_10_cluster_4['count'], color='blue')
plt.xlabel('Count')
plt.ylabel('Brand')
plt.title('Top 10 Brands in Cluster 3')
plt.show()
